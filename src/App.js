  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: "800px", width: "100%", textAlign: "center" }}>
        <h4 style={{ textTransform: "uppercase", color: "#4b5563", fontSize: "0.85rem" }}>
        ...
        >
          <span style={{ borderRight: typingFinished ? "none" : "2px solid #001f3f", paddingRight: "4px" }}>
            {typedText}
          </span>
        </h1>
        <p style={{ fontSize: "1rem", color: "#1e3a8a", marginBottom: "2rem" }}>
          Pro tip: Recruiters ghosted you? We’ll tell you why..
        </p>
      ...
      >
        Developed by <strong>Shaswat Shourya</strong> • Serving roast, not toast
      </footer>
